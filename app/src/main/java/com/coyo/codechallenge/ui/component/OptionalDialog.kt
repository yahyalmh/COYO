package com.coyo.codechallenge.ui.component
...
import com.coyo.codechallenge.util.LayoutHelper
...
class OptionalDialog(context: Context) : AlertDialog(context) {
    ...
    private fun addMessage() {
        ...
        messageTxtView.setTextColor(ContextCompat.getColor(context, R.color.coyo_black))
    ...
    private fun addHint() {
        ...
        hintTextView.setTextColor(ContextCompat.getColor(context, R.color.coyo_black))
